...
export const SECTION_REGISTRY: SectionRegistryEntry[] = [
  ...
  },
  {
    ...
    icon: 'EnvelopeSimple',
    showInNav: true,
    adminSchemaId: 'newsletter',
    configFields: [
      { path: 'labels.newsletter', label: 'Section Heading', type: 'text', placeholder: 'NEWSLETTER', disclosure: 'basic' },
      { path: 'newsletter.enabled', label: 'Enable Newsletter Section', type: 'toggle', defaultValue: true, disclosure: 'basic' },
      { path: 'newsletter.title', label: 'Section Title', type: 'text', placeholder: 'STAY CONNECTED', disclosure: 'basic' },
      { path: 'newsletter.description', label: 'Description', type: 'textarea', placeholder: 'Get the latest news, releases and gig updates.', disclosure: 'basic' },
      { path: 'newsletter.placeholder', label: 'Email Placeholder', type: 'text', placeholder: 'your@email.com', disclosure: 'advanced' },
      { path: 'newsletter.buttonText', label: 'Button Text', type: 'text', placeholder: 'SUBSCRIBE', disclosure: 'advanced' },
      { path: 'newsletter.successMessage', label: 'Success Message', type: 'text', placeholder: 'Thank you for subscribing!', disclosure: 'advanced' },
      {
        path: 'sections.styleOverrides.newsletter.backgroundOpacity',
        label: 'Background Opacity',
        type: 'slider',
        min: 0,
        max: 1,
        step: 0.05,
        defaultValue: 0.5,
        description: 'Opacity of the section background.',
        disclosure: 'advanced',
      },
    ],
  },
