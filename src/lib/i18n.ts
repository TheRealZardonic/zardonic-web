...
const translations: Record<string, Record<Locale, string>> = {
  ...
  'cookie.title':              { en: '🍪 COOKIE & DATA NOTICE', de: '🍪 COOKIE & DATENSCHUTZ', ru: '🍪 УВЕДОМЛЕНИЕ О COOKIE', it: '🍪 AVVISO COOKIE & DATI', es: '🍪 AVISO DE COOKIE & DATOS', pt: '🍪 AVISO DE COOKIE & DADOS', ja: '🍪 クッキーとデータの通知', ko: '🍪 쿠키 및 데이터 알림' },
  ...
  'cookie.essentialLabel':     { en: 'Essential Data', de: 'Essentielle Daten', ru: 'Основные данные', it: 'Dati essenziali', es: 'Datos esenciales', pt: 'Dados essenciais', ja: '必須データ', ko: '필수 데이터' },
  ...
  'cookie.analyticsLabel':     { en: 'Analytics', de: 'Analytik', ru: 'Аналитика', it: 'Analisi', es: 'Análisis', pt: 'Análise', ja: 'アナリティクス', ko: '애널리틱스' },
  'cookie.analyticsDesc':      { en: 'Helps us understand how visitors use the site.', de: 'Hilft uns zu verstehen, wie Besucher die Website nutzen.', ru: 'Помогает понять, как посетители используют сайт.', it: 'Ci aiuta a capire come i visitatori usano il sito.', es: 'Nos ayuda a entender cómo los visitantes usan el sitio.', pt: 'Ajuda-nos a perceber como os visitantes usam o site.', ja: '訪問者のサイト利用方法を把握するのに役立ちます。', ko: '방문자가 사이트를 사용하는 방법을 이해하는 데 도움이 됩니다.' },
  'cookie.essentialDesc':      { en: 'Required for core functionality: image caching, preferences.', de: 'Erforderlich für Kernfunktionen: Bild-Caching, Einstellungen.', ru: 'Необходимо для основных функций: кэширование изображений, настройки.', it: 'Necessario per le funzionalità principali: cache immagini, preferenze.', es: 'Necesario para la funcionalidad principal: caché de imágenes, preferencias.', pt: 'Necessário para as funcionalidades principais: cache de imagens, preferências.', ja: '主要機能に必要: 画像キャッシュ、設定。', ko: '핵심 기능에 필요: 이미지 캐싱, 환경설정.' },
